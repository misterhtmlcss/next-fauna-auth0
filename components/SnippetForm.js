  ...
  return (
    <form onSubmit={handleSubmit(snippet ? updateSnippet : createSnippet)}>
      <div className="mb-4">
          ...
          />
          {errors.name && (
            <p className="font-bold text-yellow-100 pl-3 bg-red-600 rounded">Name is required</p>
          )}
      </div>
      <div className="mb-4">
          <label
          ...
          {errors.language && (
            <p className="font-bold text-yellow-100 pl-3 bg-red-600 rounded">Language is required</p>
          )}
      </div>
      <div className="mb-4">
          <label
          ...
          ></textarea>
          {errors.description && (
            <p className="font-bold text-yellow-100 pl-3 bg-red-600 rounded">Description is required</p>
          )}
      </div>
      <div className="mb-4">
          <label
          ...
          ></textarea>
          {errors.code && (
            <p className="font-bold text-yellow-100 pl-3 bg-red-600 rounded">Code is required</p>
          )}
      </div>
      <button
